<template>
  <div class="text-center">
    ...
    <p class="text-center pb-2">
      ...
      or <a-button type="danger" size="small" id="restart">Restart the game</a-button>
    </p>
...
export default {
  ...
  mounted () {
    this.$nextTick(() => {
      ...
      var invaderSize = 20
      // var initialOffsetInvader
      var invaderAttackRate
      var invaderSpeed
      var invaderSpawnDelay = 25

      // Counter
      var i = 0
      var kills = 0
      var spawnDelayCounter = invaderSpawnDelay
      var invaderDownTimer

      // Text
      var blocks = [
        [1, 5, 7, 11, 13, 17, 19, 23],
        [2, 4, 7, 11, 13, 14, 16, 17, 19, 20, 22, 23],
        [2, 4, 7, 11, 13, 15, 17, 19, 21, 23],
        [3, 7, 11, 13, 15, 17, 19, 21, 23],
        [2, 4, 7, 11, 13, 17, 19, 23],
        // [2, 4, 7, 11, 13, 17, 19, 23],
        [1, 5, 8, 9, 10, 13, 17, 19, 23]
      ]
      ...
      function getPixelRow (rowRaw) {
        var textRow = []
        var placer = 0
        var row = Math.floor(rowRaw / invaderMultiplier)
