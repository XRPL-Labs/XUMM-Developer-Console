          ...
          <div class="logs" v-if="$route.name === 'app-logs'">
            ...
            <div class="data">
              <div class="no-overflow correct-code-lh">
                <span class="badge mr-1" :class="{ 'badge-primary': r.call_method === 'POST', 'badge-success': r.call_method === 'GET', 'badge-secondary': ['GET', 'POST'].indexOf(r.call_method) > -1 }">{{ r.call_method }}</span>
